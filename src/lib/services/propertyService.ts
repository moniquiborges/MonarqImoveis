  ...
  try {
    ...
    return urbanRows.map((row: any) => {
      ...
      return {
        ...
        badges: Array.isArray(row.badges) ? row.badges : ["novo", "alto-padrao"],
        coverImage,
        gallery,
  ...
  try {
    ...
    return devRows.map((row: any) => {
      ...
      return {
        ...
        badges: Array.isArray(row.badges) ? row.badges : ["lancamento", "alto-padrao"],
        coverImage,
        gallery,
        videos: videoMap.get(row.id) || [],
        description: row.description || undefined,
  ...
  try {
    ...
    return ruralRows.map((row: any) => {
      ...
      return {
        ...
        badges: Array.isArray(row.badges) ? row.badges : ["oportunidade"],
        coverImage,
        gallery,
        videos: videoMap.get(row.id) || [],
        description: row.description || undefined,
