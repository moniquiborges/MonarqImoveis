...
import { mockDevelopments, getDevelopmentsByCity } from "@/lib/mock/developments";
...
export default async function CityEmpreendimentosPage({
  ...
  const info = cityData[typedCity];
  const developments = getDevelopmentsByCity(typedCity);
